...
public class AopLog {
    ...
    */
    @Pointcut("execution(* com.aop.c2_aop.service.UserService.add(..))")
    public void logAdd(){}

    // @Before 前置通知
    @Before("execution(* com.aop.c2_aop.service.UserService.add(..) )")
    public void before(){
        System.out.println("前置通知-在方法之前通知  ");
    }

    @After("execution(* com.aop.c2_aop.service.UserService.add(..) )")
    public void after(){
    ...
    */
    ...
    /*
        可以获取 切点方法的返回值
    */
    @AfterReturning("execution(* com.aop.c2_aop.service.UserService.add(..) )")
